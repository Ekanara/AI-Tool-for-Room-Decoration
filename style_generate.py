...
def run_generate_style(prompt, guidance_scale, max_resolution, negative_prompt):
   ...
   # register_free_crossattn_upblock2d(pipeline, b1= 1.5, b2= 1.6, s1 = 0.9, s2 = 0.2)
    register_free_upblock2d(pipeline, b1=1, b2=1.2, s1=0.2, s2=0.2)
    register_free_crossattn_upblock2d(pipeline, b1= 1, b2= 1.2, s1 = 0.2, s2 = 0.2)
